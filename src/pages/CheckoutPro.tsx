...
const ProductDisplay = () => (
    <div className="flex flex-col items-center">
        ...
        <form action="/api/create-checkout-session" method="POST" className="w-full max-w-sm">
            <input type="hidden" name="lookup_key" value="Sokrate_AI_Pro-8e9030a" />
            <Button type="submit" size="lg" className="w-full text-lg py-6 shadow-lg bg-indigo-600 hover:bg-indigo-700 text-white">
                Checkout
            </Button>
        </form>
    ...
    return (
        <div className="text-center">
            <div className="mb-8">
                ...
                <h3 className="text-2xl font-bold text-green-600">Subscription Successful!</h3>
            ...
            <div className="w-full max-w-lg p-8 rounded-2xl border border-slate-100 shadow-2xl">
                ...
                {!success && (
                    <div className="mt-6 text-center">
                        <Link to="/pricing-selection" className="text-sm text-gray-500 hover:text-gray-900">
                            Cancel and return
                        </Link>
                    </div>
                )}
